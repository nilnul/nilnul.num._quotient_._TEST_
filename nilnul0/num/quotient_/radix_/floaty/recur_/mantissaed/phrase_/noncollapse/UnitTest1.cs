...
using R = nilnul.num.quotient_.nonneg_.radix_.floaty.Recur;//.Mantissaed;

using n = nilnul.num.quotient_.nonneg_.radix_.floaty;

namespace nilnul.num._quotient_._TEST_.nilnul0.num.quotient_.radix_.floaty.recur_.mantissaed.phrase_.noncollapse
{
	[TestClass]
