...
namespace nilnul.num._quotient_._TEST_.nilnul0.num.quotient_.radix.ext.errable_.ieee_.dec.of_.bits.xpn
{
	[TestClass]
	public class UnitTest1
	{
		...
		public void TestMethod1()
		{
			...
			Assert.AreEqual(decim,012340.05690m);
		}
	}
}
