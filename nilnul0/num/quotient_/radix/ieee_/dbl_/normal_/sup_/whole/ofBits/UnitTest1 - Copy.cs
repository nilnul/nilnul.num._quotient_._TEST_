...
namespace nilnul.num.quotient_.radix.ext.errable_.ieee_.bin_.noninf_.sup_.whole.ofBits
{
	[TestClass]
	public class UnitTest1
	{
		...
		public void TestMethod1()
		{
			...
			var dbl =   nilnul.num.quotient_.radix.ext.errable_.ieee_._BinX.OfBitsInLittle1st(
				new byte[] { 1, 0, 0, 0, 0, 0, 0b0011_0000, 0b0100_0011 } //1.000...0001 * 2^ 52 = 1000...00001
			);
			...
			Assert.IsTrue(
				nilnul.num.quotient.Eq2.Singleton.Equals(
					...
					,
					 ...
					 nilnul.num.quotient.of_.unary_._IndicX.DenomNonnil(2, 52 )+1
				)
			);
