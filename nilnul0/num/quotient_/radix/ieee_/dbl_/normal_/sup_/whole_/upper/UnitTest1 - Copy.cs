...
namespace nilnul.num.quotient_.radix.ext.errable_.ieee_.bin_.noninf_.sup_.whole_.upper.ofBits
{
	[TestClass]
	public class UnitTest1
	{
		...
		public void TestMethod1()
		{
			...
			var dbl =   nilnul.num.quotient_.radix.ext.errable_.ieee_._BinX.OfBitsInLittle1st(
				new byte[] { 0, 0, 0, 0, 0, 0, 0b0100_0000, 0b0_100__0011 }  // ^53
			);
			...
			var powDecrement = (1l << 53) ; //9007199254740992
